...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            name: CalmaWidget.routeName,
            path: CalmaWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'Calma')
                : NavBarPage(
                    initialPage: 'Calma',
                    page: CalmaWidget(),
                  )),
        FFRoute(
          name: AsistenteWidget.routeName,
          path: AsistenteWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Asistente')
              : AsistenteWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ProgresoWidget.routeName,
          path: ProgresoWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Progreso')
              : ProgresoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SentirWidget.routeName,
          path: SentirWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Sentir')
              : SentirWidget(),
        ),
        FFRoute(
