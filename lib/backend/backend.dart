...
import 'schema/academic_events_record.dart';
...
export 'schema/academic_events_record.dart';
...
/// Functions to query AcademicEventsRecords (as a Stream and as a Future).
Future<int> queryAcademicEventsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AcademicEventsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AcademicEventsRecord>> queryAcademicEventsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AcademicEventsRecord.collection,
      AcademicEventsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AcademicEventsRecord>> queryAcademicEventsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
