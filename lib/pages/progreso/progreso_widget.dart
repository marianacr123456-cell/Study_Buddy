...
class ProgresoWidget extends StatefulWidget {
  ...
  static String routeName = 'Progreso';
  static String routePath = '/progreso';
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    24.0, 48.0, 24.0, 32.0),
                                child: StreamBuilder<List<MoodLogsRecord>>(
                                  stream: queryMoodLogsRecord(),
                                  builder: (context, snapshot) {
                                    ...
                                    List<MoodLogsRecord>
                                        columnPaddingMoodLogsRecordList =
                                        snapshot.data!;
                                                    ...
                                                    Expanded(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            'Has completado 5 sesiones esta semana',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  // ff_lite_listview_data:${mood_logs.all}
                                                  StreamBuilder<
                                                      List<MoodLogsRecord>>(
                                                    stream:
                                                        queryMoodLogsRecord(),
                                                          ...
                                                          return ListView
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              final itemItem =
                                                                  item[
                                                                      itemIndex];
                                                              return MoodLogItemWidget(
                                                                key: Key(
                                                                    'Key558_${itemIndex}_of_${item.length}'),
                                                                emoji: itemItem
                                                                    .emoji,
                                                                mood: itemItem
                                                                    .mood,
